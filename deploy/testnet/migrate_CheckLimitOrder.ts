...
async function deploy() {
...

    {
        ...
        let fillOrderParams = {
            ...
            deadline: 1740813068,
            triggerPrice: parseUnits('75', 18).toString(),
        ...
        console.log(
            'orderInfo',
            (await limitOrderBook.getOrderHash(fillOrderParams)),
            formatEther(multiplier.longMultiplier.add(multiplier.shortMultiplier).toString()),
            nonce.toString(),
            signature,
        )
        // await waitForTx(
